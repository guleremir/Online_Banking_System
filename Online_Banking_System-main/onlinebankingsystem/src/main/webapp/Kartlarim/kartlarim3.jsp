...
<link href="../Kartlarim/kartlarim3.css" rel="stylesheet"  />
</head>
<body>
...
%>	
<div class="a">
<h2 id="baslik"> <a href="../Kartlarim/kartlarim4.jsp#" target="_self"> <i class="fas fa-angle-left" id="home1"> </i></a> <b> Banka Karti Detaylari </b> </h2>
<i class="fas fa-home" id="home"> > Kartlarim > Banka Kartlarim > Banka Karti Detaylari </i>
<div id=table4>
<table>
<tr>
...
<button class="tusŸ" type="button" id="button1"><b>KART HAREKETLERI</b></button>
...
<button class="tus" type="button" style="font-size:15px;" ><b>BANKKART KUMBARA</b></button>
...
<button class="tus" type="button" style="font-size:15px;"  ><b>KART AYARLARI</b></button>
