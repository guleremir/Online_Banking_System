...
%>
<div class="ikinci">
<h1>Kredi Kartlarim</h1>
<i class="fas fa-home" id="baslik2"> > Kartlarim > Kredi Kartlarim </i>
<br>
...
<i class="fas fa-envelope " > <a href=" #" target="_self" class="ücüncü">Gönder</a> </i>
  ...
  <a href="../Kartlarim/kartlarim2_check.jsp?userId=<%=session.getAttribute("userId")%>" target="_self" > <div class="kutu">
<table >
<tr>
